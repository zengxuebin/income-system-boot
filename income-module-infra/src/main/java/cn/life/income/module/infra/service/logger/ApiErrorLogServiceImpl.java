package cn.life.income.module.infra.service.logger;
...
import cn.life.income.module.infra.dal.mysql.logger.ApiErrorLogMapper;
...
import static cn.life.income.module.infra.dal.dataobject.logger.ApiErrorLogDO.REQUEST_PARAMS_MAX_LENGTH;
import static cn.life.income.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.life.income.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImpl implements ApiErrorLogService {
    ...
    public void createApiErrorLog(ApiErrorLogCreateReqDTO createDTO) {
        ...
        try {
            ...
            // 兜底处理，目前只有 income-cloud 会发生：https://gitee.com/incomecode/income-cloud-mini/issues/IC1O0A
