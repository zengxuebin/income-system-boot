package cn.life.income.module.infra.websocket;
...
import cn.life.income.module.infra.websocket.message.DemoReceiveMessage;
import cn.life.income.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 income.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
