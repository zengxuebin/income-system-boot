package cn.life.income.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${income.websocket.sender-rocketmq.topic}",
        consumerGroup = "${income.websocket.sender-rocketmq.consumer-group}",
