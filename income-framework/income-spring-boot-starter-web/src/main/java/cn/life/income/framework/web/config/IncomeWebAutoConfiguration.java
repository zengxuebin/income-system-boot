...
import cn.life.income.framework.web.core.filter.CacheRequestBodyFilter;
import cn.life.income.framework.web.core.filter.DemoFilter;
import cn.life.income.framework.web.core.handler.GlobalExceptionHandler;
import cn.life.income.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class IncomeWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "income.demo", havingValue = "true")
