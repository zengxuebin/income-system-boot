package cn.life.income.framework.tenant.config;

import cn.life.income.framework.common.biz.system.tenant.TenantCommonApi;
...
import cn.life.income.framework.redis.config.IncomeCacheProperties;
import cn.life.income.framework.security.core.service.SecurityFrameworkService;
import cn.life.income.framework.tenant.core.aop.TenantIgnore;
import cn.life.income.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.life.income.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.life.income.framework.tenant.core.job.TenantJobAspect;
import cn.life.income.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.life.income.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.life.income.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.life.income.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.life.income.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.life.income.framework.tenant.core.service.TenantFrameworkService;
import cn.life.income.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.life.income.framework.tenant.core.web.TenantContextWebFilter;
import cn.life.income.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "income.tenant", value = "enable", matchIfMissing = true) // 允许使用 income.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class IncomeTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     IncomeCacheProperties incomeCacheProperties,
