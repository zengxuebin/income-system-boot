 ...
 *      1）Spring Async：
 *          {@link cn.life.income.framework.quartz.config.IncomeAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 IncomeSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.life.income.framework.tenant;
