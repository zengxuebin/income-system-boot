package cn.life.income.module.system.service.social;
...
import cn.life.income.framework.common.util.cache.CacheUtils;
import cn.life.income.framework.common.util.http.HttpUtils;
import cn.life.income.framework.common.util.object.BeanUtils;
import cn.life.income.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.life.income.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import cn.life.income.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
...
import cn.life.income.module.system.dal.mysql.social.SocialClientMapper;
...
import cn.life.income.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.life.income.framework.common.util.collection.MapUtils.findAndThen;
import static cn.life.income.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.life.income.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${income.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${income.wxa-subscribe-message.miniprogram-state:formal}")
