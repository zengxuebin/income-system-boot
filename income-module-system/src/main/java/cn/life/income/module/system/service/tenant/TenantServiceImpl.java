package cn.life.income.module.system.service.tenant;
...
import cn.life.income.framework.tenant.config.TenantProperties;
...
import cn.life.income.module.system.convert.tenant.TenantConvert;
...
import cn.life.income.module.system.dal.mysql.tenant.TenantMapper;
import cn.life.income.module.system.enums.permission.RoleCodeEnum;
...
import cn.life.income.module.system.service.tenant.handler.TenantInfoHandler;
import cn.life.income.module.system.service.tenant.handler.TenantMenuHandler;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 income.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
