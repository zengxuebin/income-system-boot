...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.life.income";
    private static final String ARTIFACT_ID = "income";
    private static final String PACKAGE_NAME = "cn.life.income";
    private static final String TITLE = "收益管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.life.income";
        String artifactIdNew = "income";
        String packageNameNew = "cn.life.income";
        String titleNew = "收益管理系统";
